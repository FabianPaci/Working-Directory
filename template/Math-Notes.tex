...
% Add examples
\dfn{Cosine Rule}{Like the Sine Rule, the Cosine Rule allows for angles and sides to be found within a non-right-angled triangle. The Cosine Rule is:\\\[a^2 = b^2 + c^2 -2ab\cos{A}\]}
